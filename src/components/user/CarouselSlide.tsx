...
export default function CarouselSlide({ showSideBox = false, item }: Props) {
  return (
    <div className='flex justify-center items-center h-screen -mt-32'>
      <div className='flex w-full space-x-5'>
        {showSideBox && (
          <div className='w-[7%] h-[500px] bg-brand-bg1 min-h-[100px] rounded-tr-lg rounded-br-lg'></div>
        )}

        <div
          className={`w-[86%] h-[500px] rounded-lg  bg-brand-bg1 border-4 border-brand-bg2`}
        >
          <div className='w-full h-full text-brand-black flex flex-col justify-center items-center'>
            ...
            <div className='mb-3 text-center'>
              ...
              <div className='font-hakgyo text-hakgyo-l'>{item.title}</div>
            </div>
