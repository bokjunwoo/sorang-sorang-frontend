        ...
        {step === 1 && (
          <div className='flex flex-col items-center h-full'>
            ...
            >
              ...
              <div className='text-brand-black pt-[35%]'>
                <Input
              ...
              <div className='absolute bottom-10 left-0 right-0 px-4'>
                <Button
                  variant={
                    nameForm.watch('name') ? 'master' : 'master_disabled'
                  }
        ...
        {step === 2 && (
          <div className='flex flex-col items-center h-full'>
            ...
            >
              ...
              <div className='font-pretendard text-pretendard-l pt-[35%] flex gap-[16px]'>
                <button
                  type='button'
              ...
              <div className='absolute bottom-10 left-0 right-0 px-4'>
                <Button
                  variant={
                    genderForm.watch('gender') ? 'master' : 'master_disabled'
                  }
          ...
          <div className='flex flex-col items-center h-full'>
            ...
            >
              ...
              <div className='absolute bottom-10 left-0 right-0 px-4'>
                <Button
                  variant={
                    numberForm.watch('number') ? 'master' : 'master_disabled'
                  }
        ...
        {step === 4 && (
          <div className='flex flex-col items-center h-full'>
            ...
            >
              ...
              <div className='font-pretendard text-pretendard-m pt-[15%] grid grid-cols-3 gap-y-[20px] gap-x-[12px]'>
                {Object.keys(REGION_KEYWORDS).map((region) => (
                  <button
                    key={region}
                    type='button'
                    onClick={() =>
                      regionForm.setValue('region', region as RegionType)
                    }
                    className={cn(
              ...
              <div className='absolute bottom-10 left-0 right-0 px-4'>
                <Button
                  variant={
                    regionForm.watch('region') ? 'master' : 'master_disabled'
                  }
        ...
        {step === 5 && (
          <div className='flex flex-col items-center h-full'>
            ...
            >
              ...
              <div className='font-pretendard text-pretendard-m pt-4 grid grid-cols-1 gap-y-[20px] gap-x-[12px]'>
                {REGION_KEYWORDS[masterInfo.region as RegionType]?.map(
                  (keyword) => (
                    <button
                      key={keyword}
                      type='button'
              ...
              <div className='absolute bottom-10 left-0 right-0 px-4'>
                <Button
                  variant={
                    keywordForm.watch('keyword') ? 'master' : 'master_disabled'
                  }
